...
We used Python to perform all these steps using NLTK as the primary library. We relied on the tutorial \cite{sah_2018} to understand how to use this library and implement the required analysis.
